  ...
  @RequestParam String password, HttpServletRequest request) {
    ...
    User loggedInUser = userRepository.findByEmail(email);
      ...
      try {
          ...
          Long timestamp = Instant.now().toEpochMilli(); // Gets current timestamp for last login date

          userRepository.updateLastLoginDate(loggedInUser.getUserId(), timestamp);
          ...
          responseBody.put("lastLogin", timestamp);
